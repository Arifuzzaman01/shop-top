...
export type Order = {
  ...
  status?: "pending" | "inProgress" | "outOfDelivery" | "completed" | "cancelled" | "collected";
  orderData?: string;
};
...
export type DEAL_PRODUCTResult = Array<{
  ...
  status?: "hot" | "new" | "outOfStock" | "sales";
